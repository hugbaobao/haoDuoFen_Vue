  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "复制落地页排行", icon: "CopyLanding", noCache: true },
      },
      {
        path: "search",
        name: "CopySearch",
        component: () => import("@/views/copy/CopySearch.vue"),
        meta: { title: "复制搜索词统计", icon: "CopySearch", noCache: true },
      },
      {
        path: "area",
        name: "CopyArea",
      ...
      },
      {
        ...
        meta: { title: "复制微信号统计", icon: "CopyNumber", noCache: true },
      },
      {
        path: "visitor",
        name: "CopyVisitor",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "转化落地页统计", icon: "CvsLanding", noCache: true },
      },
      {
        path: "chat",
        name: "CvsChat",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "小程序真实到粉统计", icon: "myfans", noCache: true },
      },
      {
        path: "public",
        name: "mypublic",
